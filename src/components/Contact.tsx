    ...
    <section id="contato" className="py-12 md:py-16 lg:py-20 bg-background">
      <div className="container px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="backdrop-blur-md bg-card/80 border border-border/50 rounded-xl md:rounded-2xl p-6 md:p-8 shadow-xl space-y-6 md:space-y-8">
            <div className="flex items-start gap-3 md:gap-4">
              <div className="w-10 h-10 md:w-12 md:h-12 backdrop-blur-md bg-primary/20 border border-primary/30 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div className="pt-2 md:pt-4 border-t border-border/50">
              ...
              <div className="flex gap-3 md:gap-4">
                <a
                  href="#"
                  className="w-10 h-10 md:w-12 md:h-12 backdrop-blur-md bg-primary/20 border border-primary/30 rounded-lg md:rounded-xl flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all"
          ...
          {/* Map */}
          <div className="rounded-xl md:rounded-2xl overflow-hidden shadow-xl h-[300px] sm:h-[350px] lg:h-auto lg:min-h-[500px] border border-border/50">
            <iframe
