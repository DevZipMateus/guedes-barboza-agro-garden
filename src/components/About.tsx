    ...
    <section id="sobre" className="py-20 bg-muted">
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <div className="bg-card rounded-2xl p-8 md:p-12 shadow-soft">
            ...
            <p className="text-muted-foreground leading-relaxed text-lg mt-4">
              Desde o início, a empresa se sustentou enfrentando não só os desafios normais de um mercado em expansão, mas também as adversidades climáticas da região onde estamos sediados. Superar essas condições desafiadoras foi uma grande vitória e moldou nossa resiliência e capacidade de inovação. Hoje, cada conquista reflete não só o nosso crescimento, mas a nossa determinação em prosperar mesmo diante das inúmeras dificuldades.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg">
            No nosso segmento, atuamos tanto no mercado agropecuário quanto no mercado urbano, oferecendo soluções para uma ampla gama de clientes. Nosso mercado inclui desde produtores rurais que buscam tecnologias sustentáveis e eficientes até consumidores urbanos interessados em soluções para hortas, jardins e espaços verdes em casa ou em pequenos negócios. Essa diversidade nos permite atender a diferentes necessidades e contribuir para um mercado mais sustentável e inovador, tanto no campo quanto na cidade.
          </p>
        </div>
      </div>
    </section>
